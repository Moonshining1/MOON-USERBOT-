...
alive_logo = ALIVE_PIC or "https://telegra.ph/file/a1e74f1efb414810c21ef.jpg"
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"├• **ѕυρρσят**: [Click](t.me/TheWarriorsxNetwork)\n"
        f"├• **¢нαииєℓ**: [Click](t.me/Moonshining_Society)\n"
        f"└• **ᴅᴇᴠᴇʟᴏᴘᴇʀ **: [ᴍᴏᴏɴ](t.me/Moonshining2)"        
    )
...
async def repo(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await message.edit("Here is repo: \n\n\nhttps://github.com/Moonshining1/MOON-USERBOT\nFork & Give an ⭐")


@Client.on_message(filters.command("creator", ".") & filters.me)
async def creator(bot: Client, message: Message):
    await message.edit("https://gitHub.com/Moonshining1")
